...
import com.digitalarx.android.files.InstantUploadBroadcastReceiver;
...
public class InstantUploadActivity extends Activity {
    ...
    private void startUpload(String img_path) {
        ...
        if (canInstantUpload()) {
            ...
            i.putExtra(com.digitalarx.android.files.services.FileUploader.KEY_INSTANT_UPLOAD, true);
